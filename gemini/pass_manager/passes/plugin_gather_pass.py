...
from ..transformer.plugin_gather_transformer import PluginGatherTransformer
...
class PluginGatherPass(PassBase):
    ...
    def __init__(self):
        # type: (None) -> None
        super(PluginGatherPass, self).__init__()
        self._solvers = []
        self._solvers.append(PluginGatherTransformer)
