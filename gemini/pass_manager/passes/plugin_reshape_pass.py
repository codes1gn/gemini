...
from ..transformer.plugin_reshape_transformer import PluginReshapeTransformer
...
class PluginReshapePass(PassBase):
    ...
    def __init__(self):
        # type: (None) -> None
        super(PluginReshapePass, self).__init__()
        self._solvers = []
        self._solvers.append(PluginReshapeTransformer)
    ...
    def run_pass(self, _cnode):
        ...
        _cnode.dump(pretty=True, prefix='apply_reshape_pass')
        return _cnode
